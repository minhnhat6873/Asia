...
const systems = [
  {
    ...
    href: "https://wana.vn/crm",
    icon: UsersRound,
  },
  {
    name: "Wiki",
    description: "Kho kiến thức nội bộ",
    href: "https://wiki.wana.vn",
    icon: BookOpen,
  },
  {
    name: "LMS",
    description: "Đào tạo & học tập",
    href: "https://wana.vn/lms",
    icon: GraduationCap,
  },
  {
    name: "ERP",
    description: "Quản lý doanh nghiệp",
    href: "https://wana.vn/app/home",
  ...
  return (
    <div ref={menuRef} className="relative">
      ...
      {open && (
        <div
          role="menu"
          className="absolute left-0 top-full z-50 mt-2 w-64 overflow-hidden rounded-2xl border border-gray-100 bg-white p-2 shadow-[0_18px_45px_rgba(15,81,50,0.16)]"
        >
          {systems.map(({ name, description, href, icon: Icon }) => (
            ...
            >
              ...
              <ArrowRight size={17} className="shrink-0 text-[#0d5c0d] transition-transform group-hover:translate-x-0.5" />
            </a>
          ))}
        </div>
      )}
